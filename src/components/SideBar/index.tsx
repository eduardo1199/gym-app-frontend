import { ListDashes, Student, Gear, PersonSimpleRun, CaretRight } from "phosphor-react";
...
export function SideBar() {
  ...
  if(match) {
    return (
      <>
        <button onClick={toggleOpenOrCloseDrawer} className="w-[70px] flex bg-primary-purple relative hover:bg-secondary-purple transition-colors">
          <CaretRight size={20} weight="bold" color="#fff" className="fixed bottom-1/2 mx-5" />        
        </button>
